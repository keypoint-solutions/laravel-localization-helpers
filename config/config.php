...
return [
    ...
    */
    ...
    | - first in base_path() . DIRECTORY_SEPARATOR . 'lang',
    ...
    */
    ...
    /*
     |--------------------------------------------------------------------------
     | Prefix to be added before not translated lemma values
     |--------------------------------------------------------------------------
     */
    'todo_prefix' => 'TODO: ',
    ...
    /*
     |--------------------------------------------------------------------------
     | Whether to encode JSON unicode characters (ex. \ud83d\udea9 vs 🚩) or not
     |--------------------------------------------------------------------------
     */
    'encode_json_unicode_characters' => true,
];
